from questions.question_mdp_25_num_bits.question_transformer import QuestionTransformer
...
directory_latex = "questions/question_mdp_25_num_bits/"
...
version_path = "question_mdp_25_num_bits"
...
#make_version = QuestionTransformer(python_files_list, general_files_to_change_list, directory_latex, num_versions, output_index, version_path, 71708)
