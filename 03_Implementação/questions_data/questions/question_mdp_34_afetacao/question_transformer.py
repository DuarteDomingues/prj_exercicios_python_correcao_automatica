...
class QuestionTransformer(GenerateRandomVersion):
	...
	def create_python_program(self, python_files_list, version):
		...
		numbers_list = random.sample(range(10,100), 4)
		self.__numbers_list = numbers_list

		list_strings = ["x", "10", "100", "200", "300"]
		...
		change_all_occurrences(list_strings[3], str(numbers_list[2]))
		change_all_occurrences(list_strings[4], str(numbers_list[3]))
	...
	def create_latex_files(self, general_latex_files, version, output):
		...
		true_output = "["+str(self.__numbers_list[0])+", "+str(self.__numbers_list[0])+", "+str(self.__numbers_list[0])+"]"+r'\newline'+\
						"["+str(self.__numbers_list[1])+", "+str(self.__numbers_list[0])+", "+str(self.__numbers_list[0])+"]"+r'\newline'+\
						"["+str(self.__numbers_list[1])+", "+str(self.__numbers_list[2])+", "+str(self.__numbers_list[0])+"]"+r'\newline'+\
						"["+str(self.__numbers_list[1])+", "+str(self.__numbers_list[2])+", "+str(self.__numbers_list[3])+"]"

		false_output = "["+str(self.__numbers_list[1])+", "+str(self.__numbers_list[2])+", "+str(self.__numbers_list[3])+"]"+r'\newline'+\
						"["+str(self.__numbers_list[1])+", "+str(self.__numbers_list[2])+", "+str(self.__numbers_list[3])+"]"+r'\newline'+\
						"["+str(self.__numbers_list[1])+", "+str(self.__numbers_list[2])+", "+str(self.__numbers_list[3])+"]"+r'\newline'+\
						"["+str(self.__numbers_list[1])+", "+str(self.__numbers_list[2])+", "+str(self.__numbers_list[3])+"]"
