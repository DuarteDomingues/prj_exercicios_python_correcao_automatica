...
class QuestionTransformer(GenerateRandomVersion):
	...
	def create_latex_files(self, general_latex_files, version, output):
		...
		true_output = "["+str(self.__numbers_list[0])+", "+str(self.__numbers_list[1])+", "+str(self.__numbers_list[0])+"]"+r"\newline "+\
						"["+str(self.__numbers_list[0])+", "+str(self.__numbers_list[1])+", "+str(self.__numbers_list[0])+"]"+r"\newline "
		

		false_output = "["+str(self.__numbers_list[0])+", "+str(self.__numbers_list[1])+", "+str(self.__numbers_list[0])+"]"+r"\newline "
		false_output = false_output+"["+str(self.__numbers_list[0])+", "+str(self.__numbers_list[0])+", "+str(self.__numbers_list[0])+"]"
