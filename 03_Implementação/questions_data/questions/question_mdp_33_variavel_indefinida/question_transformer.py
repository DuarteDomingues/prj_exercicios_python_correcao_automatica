...
class QuestionTransformer(GenerateRandomVersion):
	...
	def create_python_program(self, python_files_list, version):
		...
		change_all_occurrences(list_strings[0], letters)
		change_token_all_occurrences(list_strings[1], str(numbers_list[0]))
		change_token_all_occurrences(list_strings[2], str(numbers_list[1]))
	...
	def create_latex_files(self, general_latex_files, version, output):
		...
		errors_type = ["GeneratorExit", "KeyError", "SyntaxError", "ReferenceError", "RuntimeError", "UnicodeError"]
