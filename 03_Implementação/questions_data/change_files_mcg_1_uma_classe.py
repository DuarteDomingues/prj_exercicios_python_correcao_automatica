from questions.question_mcg_1_uma_classe.question_transformer import QuestionTransformer
...
directory_latex = "questions/question_mcg_1_uma_classe/"
...
general_files_to_change_list = ['true_or_false_question',
								...
								'true_or_false_answer_4_true',
								'true_or_false_answer_4_false',
								'true_or_false_answer_5_true',
								'true_or_false_answer_5_false']

num_versions = 3


# output_index -> index of the output (0-program, 1-full_program)
output_index = 1

# folder where the question is going to be
version_path = "question_mcg_1_uma_classe"
...
#make_version = QuestionTransformer(python_files_list, general_files_to_change_list, directory_latex, num_versions, output_index, version_path, 14348)
...
file_gen = FilesGenerator(general_files_to_change_list, directory, num_versions, maintain_files = False)
