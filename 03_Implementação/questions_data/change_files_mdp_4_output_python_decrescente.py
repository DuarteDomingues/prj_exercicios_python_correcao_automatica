from questions.question_mdp_4_output_python_decrescente.question_transformer import QuestionTransformer
...
directory_latex = "questions/question_mdp_4_output_python_decrescente/"
...
version_path = "question_mdp_4_output_python"
...
#make_version = QuestionTransformer(python_files_list, general_files_to_change_list, directory_latex, num_versions, output_index, version_path, 37497)
