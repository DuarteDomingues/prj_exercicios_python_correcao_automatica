from questions.question_mcg_19_somador.question_transformer import QuestionTransformer
...
directory_latex = "questions/question_mcg_19_somador/"
...
version_path = "question_mcg_19_somador"
...
make_version = QuestionTransformer(python_files_list, general_files_to_change_list, directory_latex, num_versions, output_index, version_path, 69214)
