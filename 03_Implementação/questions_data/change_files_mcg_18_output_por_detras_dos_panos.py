from questions.question_mcg_18_output_por_detras_dos_panos.question_transformer import QuestionTransformer
...
directory_latex = "questions/question_mcg_18_output_por_detras_dos_panos/"
...
version_path = "question_mcg_18_output_por_detras_dos_panos"
...
#make_version = QuestionTransformer(python_files_list, general_files_to_change_list, directory_latex, num_versions, output_index, version_path, 72075)
...
merge_latex_file = MergeFiles(general_files_to_change_list, directory, num_versions, add_new_line=False)
