from questions.question_mdp_20_listas_tuplos.question_transformer import QuestionTransformer
...
directory_latex = "questions/question_mdp_20_listas_tuplos/"
...
version_path = "question_mdp_20_listas_tuplos"
...
#make_version = QuestionTransformer(python_files_list, general_files_to_change_list, directory_latex, num_versions, output_index, version_path, 55054)
