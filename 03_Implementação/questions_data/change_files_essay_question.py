from questions.question_essay_question.question_transformer import QuestionTransformer
...
directory_latex = "questions/question_essay_question/"
...
version_path = "question_essay_question"
...
#make_version = QuestionTransformer(python_files_list, general_files_to_change_list, directory_latex, num_versions, output_index, version_path, 24678)
