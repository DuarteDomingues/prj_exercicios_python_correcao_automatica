from questions.question_mcg_16_erro_init.question_transformer import QuestionTransformer
...
directory_latex = "questions/question_mcg_16_erro_init/"
...
version_path = "question_mcg_16_erro_init"
...
#make_version = QuestionTransformer(python_files_list, general_files_to_change_list, directory_latex, num_versions, output_index, version_path, 91115)
...
#file_gen = FilesGenerator(general_files_to_change_list, directory,  maintain_files= True)
file_gen.execute()
