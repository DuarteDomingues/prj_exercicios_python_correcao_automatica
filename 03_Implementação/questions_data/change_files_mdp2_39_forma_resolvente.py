from questions.question_mdp2_39_forma_resolvente.question_transformer import QuestionTransformer
...
directory_latex = "questions/question_mdp2_39_forma_resolvente/"

python_files_list = [
    'program.py','full_program.py'
]
...
version_path = "question_mdp2_39_forma_resolvente"
...
#make_version = QuestionTransformer(python_files_list, general_files_to_change_list, directory_latex, num_versions, output_index, version_path, 66078)
