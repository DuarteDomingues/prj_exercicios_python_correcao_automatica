from questions.question_mdp_35_string_imutavel.question_transformer import QuestionTransformer
...
directory_latex = "questions/question_mdp_35_string_imutavel/"
...
version_path = "question_mdp_35_string_imutavel"
...
#make_version = QuestionTransformer(python_files_list, general_files_to_change_list, directory_latex, num_versions, output_index, version_path, 25847)
