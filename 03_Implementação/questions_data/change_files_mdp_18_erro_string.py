from questions.question_mdp_18_erro_string.question_transformer import QuestionTransformer
...
directory_latex = "questions/question_mdp_18_erro_string/"
...
version_path = "question_mdp_18_erro_string"
...
#make_version = QuestionTransformer(python_files_list, general_files_to_change_list, directory_latex, num_versions, output_index, version_path, 50379)
