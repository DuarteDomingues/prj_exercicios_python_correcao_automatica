from questions.question_mcg_11_classe.question_transformer import QuestionTransformer
...
directory_latex = "questions/question_mcg_11_classe/"
...
version_path = "question_mcg_11_classe"
...
#make_version = QuestionTransformer(python_files_list, general_files_to_change_list, directory_latex, num_versions, output_index, version_path, 75452)
