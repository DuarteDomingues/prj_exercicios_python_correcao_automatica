from questions.question_mdp2_1_print_funcao.question_transformer import QuestionTransformer
...
directory_latex = "questions/question_mdp2_1_print_funcao/"
...
version_path = "question_mdp2_1_print_funcao"
...
#make_version = QuestionTransformer(python_files_list, general_files_to_change_list, directory_latex, num_versions, output_index, version_path, 85199)
