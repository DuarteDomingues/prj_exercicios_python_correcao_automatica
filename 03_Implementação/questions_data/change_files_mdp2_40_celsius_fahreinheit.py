from questions.question_mdp2_40_celsius_fahreinheit.question_transformer import QuestionTransformer
...
directory_latex = "questions/question_mdp2_40_celsius_fahreinheit/"
...
version_path = "question_mdp2_40_celsius_fahreinheit"
...
#make_version = QuestionTransformer(python_files_list, general_files_to_change_list, directory_latex, num_versions, output_index, version_path, 36568)
