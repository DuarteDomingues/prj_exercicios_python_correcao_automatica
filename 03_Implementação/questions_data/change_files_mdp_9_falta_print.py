from questions.question_mdp_9_falta_print.question_transformer import QuestionTransformer
...
directory_latex = "questions/question_mdp_9_falta_print/"
...
version_path = "question_mdp_9_falta_print"
...
#make_version = QuestionTransformer(python_files_list, general_files_to_change_list, directory_latex, num_versions, output_index, version_path, 96576)
