from questions.question_mdp_31_variavel_numero.question_transformer import QuestionTransformer
...
directory_latex = "questions/question_mdp_31_variavel_numero/"
...
version_path = "question_mdp_31_variavel_numero"
...
#make_version = QuestionTransformer(python_files_list, general_files_to_change_list, directory_latex, num_versions, output_index, version_path, 38065)
